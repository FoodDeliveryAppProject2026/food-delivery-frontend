...
test.each([
  ...
  ["omar", "hisham", "omarhisham@gmail.com", "omar2005" , "01235423243"]
   ...
   test.each([
  ["example", "test", "example123@outlook.com", "asdasd_21332" , "omar" , "01066027761"],
  ["omar", "hisham", "omarhisham@gmail.com", "omar2005" , "omar" , "01066027761"]
])('Putting an unmatched passwords', (first, last, email, password , password2 , phone) =>{
        const continuebutton = document.getElementById('continueBtn');
...
])('Phone Number Smaller Than 11 Numbers', (first, last, email, password , phone) =>{
        const continuebutton = document.getElementById('continueBtn');
...
test.each([
  ["example", "test", "example123@outlook.com", "asdasd_21332" , "0106612421410"],
  ["omar", "hisham", "omarhisham@gmail.com", "omar2005" , "0123214124215"]
])('Phone Number Longer Than 11 Numbers', (first, last, email, password , phone) =>{
        const continuebutton = document.getElementById('continueBtn');
