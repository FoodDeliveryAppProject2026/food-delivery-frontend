...
const menuData = [
  ...
  },
  {
    ...
    items: [
      {
        id: 15, name: "Crispy Chicken Meal",
        desc: "Crispy chicken fillet + fries + drink",
        price: 199, oldPrice: null, likes: 1430,
  ...
  },
  {
    ...
    items: [
      {
        id: 16, name: "Grilled Chicken Sandwich",
        desc: "Grilled chicken breast, garlic sauce, lettuce, tomato on whole wheat bun",
        price: 159, oldPrice: null, likes: 890,
        img: "https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=400&q=80"
      },
      {
        id: 17, name: "Crispy Chicken Sandwich",
        desc: "Crispy fried chicken, mayo, pickles, on brioche",
        price: 149, oldPrice: null, likes: 2200,
        img: "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400&q=80"
      }
    ]
  },
  {
    ...
    items: [
      {
        id: 18, name: "Nacho Burger Meal",
        desc: "Willy's nacho burger + nacho chips + drink",
        price: 299, oldPrice: 359, likes: 760,
        img: "https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=400&q=80"
      }
    ]
  },
...
function renderMenu(filter = "") {
  ...
  menuData.forEach(section => {
    const items = q
      ? section.items.filter(i => i.name.toLowerCase().includes(q) || i.desc.toLowerCase().includes(q))
      : section.items;
...
function openModal(item) {
  ...
  document.getElementById("modalLikes").textContent = `❤️ ${item.likes} people liked this`;
  document.getElementById("modalOldPrice").textContent = item.oldPrice ? item.oldPrice + " EGP" : "";
